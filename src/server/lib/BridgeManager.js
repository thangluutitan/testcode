...
var BridgeManager = {
    ...
    init: function () {
        ...
        Observer.subscribe(this, Const.pushNotificationSendMessage, function (who, obj) {
        ...
        Observer.subscribe(this, Const.notificationStatusChanges, function (who, obj) {

            if (_.isEmpty(Settings.listeners))
                return;

            if (_.isFunction(Settings.listeners.OnStatusChanges))
                Settings.listeners.OnStatusChanges(obj);
