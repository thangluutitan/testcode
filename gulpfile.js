...
gulp.task('lint', function () {
  return gulp.src([
                    'src/server/*.js',
                    'src/server/WebAPI/*.js',
                    'src/server/lib/*.js',
                    'src/server/Logics/*.js',
                    'src/server/SocketAPI/*.js',
                    'src/server/test/*.js',
                    'src/server/test/frog/*.js',
...
gulp.task('frog-test', function (done) {
    return gulp.src('src/server/test/frog/*.js', { read: false })
    .pipe(mocha({ reporter: 'spec' }))
    .pipe(exit());
});
